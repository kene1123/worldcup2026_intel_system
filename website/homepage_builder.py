""" homepage_builder.py — GitHub Pages Fixed Version """
...
def _get_latest_articles(limit=6):
    """Retrieve up to 'limit' valid markdown articles sorted by modification time."""
    if not ARTICLES_DIR.exists():
        return []
    
    # Exclude system pages and files smaller than 500 bytes
    files = [
    ...
    # Sort by latest modification time first
    files.sort(key=lambda f: f.stat().st_mtime, reverse=True)
    return files[:limit]

def _article_cards(files):
    """Generate HTML card components for the provided list of files."""
    if not files:
        return """
        <div class="empty">
    ...
    for i, f in enumerate(files):
        stem = f.stem
        href = f"{SITE_ROOT}/articles/{stem}.html"
        
        # Determine card types and labels based on the filename stem
...
def build_homepage():
    """Assemble the components and compile the main landing page HTML file."""
    ...
    <div class="hero">
        ...
        <p>
            Live match coverage, group standings, qualification tracking, 
            host city guides, and AI-generated match reports.
        </p>
    ...
    <div class="section-header">
        ...
        <a class="section-more" href="{SITE_ROOT}/articles/index.html">
            All reports →
        </a>
    </div>
    ...
    <div class="fixture-grid">
        <div class="fixture-card upcoming">
            ...
            <div style="padding:.25rem 0;">
                ...
                <div style="font-size:13px;color:var(--text-2);margin-bottom:.75rem;">
                    Next scheduled World Cup matches.
                </div>
                <a class="card-link" href="{SITE_ROOT}/upcoming.html">
                    View fixtures →
                </a>
            </div>
        </div>
        ...
        <div class="fixture-card upcoming">
            ...
            <div style="padding:.25rem 0;">
                ...
                <div style="font-size:13px;color:var(--text-2);margin-bottom:.75rem;">
                    Group standings and knockout qualification.
                </div>
                <a class="card-link" href="{SITE_ROOT}/qualification.html">
                    View tracker →
                </a>
            </div>
        </div>
        ...
        <div class="fixture-card upcoming">
            ...
            <div style="padding:.25rem 0;">
                ...
                <a class="card-link" href="{SITE_ROOT}/timeline.html">
                    View timeline →
                </a>
            </div>
        </div>
        ...
        <div class="fixture-card upcoming">
            ...
            <div style="padding:.25rem 0;">
                ...
                <div style="font-size:13px;color:var(--text-2);margin-bottom:.75rem;">
                    Stadiums, attractions and venue guides.
                </div>
                <a class="card-link" href="{SITE_ROOT}/host-cities.html">
                    Explore cities →
                </a>
            </div>
        </div>
    ...
    # Render with parent wrapper and save
